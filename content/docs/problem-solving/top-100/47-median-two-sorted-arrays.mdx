...
<TranslatedText
  en="- **Three Approaches**: Merge (simple), No extra space (optimized), Binary search (optimal)"
  bn="- **তিনটি পদ্ধতি**: মার্জ (সহজ), অতিরিক্ত স্পেস নেই (অপটিমাইজড), বাইনারি সার্চ (সর্বোত্তম)"
/>

<TranslatedText
  en="- **Optimal Complexity**: O(log(min(m,n))) using binary search on smaller array"
  bn="- **সর্বোত্তম কমপ্লেক্সিটি**: ছোট অ্যারেতে বাইনারি সার্চ ব্যবহার করে O(log(min(m,n)))"
/>

<TranslatedText
  en="- **Partition Concept**: Key to binary search is finding correct partition where max(left) ≤ min(right)"
  bn="- **পার্টিশন ধারণা**: বাইনারি সার্চের চাবিকাঠি হলো সঠিক পার্টিশন খুঁজে পাওয়া যেখানে max(বাম) ≤ min(ডান)"
/>

<TranslatedText
  en="- **Practical Use**: Statistics, data analysis, database optimization"
  bn="- **ব্যবহারিক ব্যবহার**: পরিসংখ্যান, ডেটা বিশ্লেষণ, ডেটাবেস অপটিমাইজেশন"
/>
