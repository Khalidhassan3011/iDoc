...
<TranslatedText
  en="- **Set Approach:** Best for general use cases when you need to find duplicates quickly"
  bn="- **সেট পদ্ধতি:** সাধারণ ক্ষেত্রে দ্রুত ডুপ্লিকেট খুঁজে পেতে সেরা"
/>

<TranslatedText
  en="- **Hash Map Approach:** Use when you need frequency counts along with duplicates"
  bn="- **হ্যাশ ম্যাপ পদ্ধতি:** ডুপ্লিকেটের সাথে ফ্রিকোয়েন্সি কাউন্ট প্রয়োজন হলে ব্যবহার করুন"
/>

<TranslatedText
  en="- **Sorting Approach:** Good when space is constrained and modifying the array is acceptable"
  bn="- **সাজানো পদ্ধতি:** স্থান সীমিত এবং অ্যারে পরিবর্তন করা গ্রহণযোগ্য হলে ভালো"
/>
