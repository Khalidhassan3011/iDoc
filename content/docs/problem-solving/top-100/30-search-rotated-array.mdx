...
<TranslatedText
  en="✓ Rotated sorted array has two sorted portions
✓ Modified binary search achieves O(log n) in single pass
✓ Always identify which half is sorted first
✓ Check if target is in sorted half's range before deciding direction
✓ This pattern applies to many rotation-related problems
✓ With duplicates, worst case becomes O(n)"
  bn="✓ ঘোরানো সাজানো অ্যারেতে দুটি সাজানো অংশ রয়েছে
✓ পরিবর্তিত বাইনারি সার্চ একক পাসে O(log n) অর্জন করে
✓ সর্বদা প্রথমে কোন অর্ধেক সাজানো তা চিহ্নিত করুন
✓ দিক নির্ধারণের আগে লক্ষ্য সাজানো অর্ধেকের পরিসরে আছে কিনা পরীক্ষা করুন
✓ এই প্যাটার্ন অনেক ঘূর্ণন-সম্পর্কিত সমস্যার ক্ষেত্রে প্রযোজ্য
✓ ডুপ্লিকেটের সাথে, সবচেয়ে খারাপ ক্ষেত্রে O(n) হয়ে যায়"
/>
