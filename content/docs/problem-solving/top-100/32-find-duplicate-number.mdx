...
<TranslatedText
  en="✓ Hash set is the most practical solution for general case
✓ Floyd's cycle detection is brilliant for O(1) space when numbers are 1 to n
✓ Always clarify problem constraints before choosing approach
✓ Sorting modifies array but uses less space
✓ XOR works only for specific constraint (numbers 1 to n, one duplicate twice)
✓ Different variations require different optimal solutions"
  bn="✓ হ্যাশ সেট সাধারণ ক্ষেত্রে সবচেয়ে ব্যবহারিক সমাধান
✓ ফ্লয়েডের সাইকেল ডিটেকশন O(1) স্থানের জন্য চমৎকার যখন সংখ্যা 1 থেকে n
✓ পদ্ধতি বেছে নেওয়ার আগে সর্বদা সমস্যার সীমাবদ্ধতা স্পষ্ট করুন
✓ সাজানো অ্যারে পরিবর্তন করে কিন্তু কম স্থান ব্যবহার করে
✓ XOR শুধুমাত্র নির্দিষ্ট সীমাবদ্ধতার জন্য কাজ করে (সংখ্যা 1 থেকে n, একটি ডুপ্লিকেট দুবার)
✓ বিভিন্ন ভেরিয়েশনের বিভিন্ন সর্বোত্তম সমাধান প্রয়োজন"
/>
