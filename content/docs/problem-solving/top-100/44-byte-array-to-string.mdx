...
```
Input: [240, 159, 152, 128]  // UTF-8 bytes for 😀
Output: "😀"
```
...
void main() {
  ...
  List<int> bytes2 = [240, 159, 152, 128]; // 😀
  print('UTF-8 emoji: ${byteArrayToStringUTF8(bytes2)}');

  // Accented characters
  List<int> bytes3 = [195, 169]; // é
...
void testByteArrayToString() {
  ...
  // Test 4: UTF-8 emoji
  List<int> emojiBytes = utf8.encode('😀');
  assert(utf8.decode(emojiBytes) == '😀');
