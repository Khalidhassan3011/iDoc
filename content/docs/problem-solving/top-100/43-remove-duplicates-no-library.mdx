...
<TranslatedText
  en="- **No Library Constraint**: Must implement duplicate detection using only basic arrays and loops"
  bn="- **কোনো লাইব্রেরি সীমাবদ্ধতা**: শুধুমাত্র মৌলিক অ্যারে এবং লুপ ব্যবহার করে ডুপ্লিকেট সনাক্তকরণ বাস্তবায়ন করতে হবে"
/>

<TranslatedText
  en="- **Three Main Approaches**: Temporary array (O(n²)), Sort first (O(n log n)), Hash table (O(n))"
  bn="- **তিনটি প্রধান পদ্ধতি**: টেম্পোরারি অ্যারে (O(n²)), প্রথমে সর্ট (O(n log n)), হ্যাশ টেবিল (O(n))"
/>

<TranslatedText
  en="- **Order Preservation**: Temporary array and hash table preserve order, sorting does not"
  bn="- **অর্ডার সংরক্ষণ**: টেম্পোরারি অ্যারে এবং হ্যাশ টেবিল অর্ডার সংরক্ষণ করে, সর্টিং করে না"
/>

<TranslatedText
  en="- **Hash Table Power**: Manual hash table implementation shows how Set/Map work internally"
  bn="- **হ্যাশ টেবিল শক্তি**: ম্যানুয়াল হ্যাশ টেবিল বাস্তবায়ন দেখায় Set/Map অভ্যন্তরীণভাবে কীভাবে কাজ করে"
/>

<TranslatedText
  en="- **Practical Skill**: Understanding low-level implementations builds stronger problem-solving abilities"
  bn="- **ব্যবহারিক দক্ষতা**: নিম্ন-স্তরের বাস্তবায়ন বোঝা শক্তিশালী সমস্যা সমাধান ক্ষমতা তৈরি করে"
/>
