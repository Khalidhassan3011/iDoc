...
<TranslatedText
  en="- **For leftmost:** When we find the target, we continue searching LEFT to ensure we find the first occurrence"
  bn="- **বামতমের জন্য:** যখন আমরা টার্গেট খুঁজে পাই, আমরা বামে সার্চ চালিয়ে যাই প্রথম ঘটনা খুঁজে পেতে"
/>

<TranslatedText
  en="- **For rightmost:** When we find the target, we continue searching RIGHT to ensure we find the last occurrence"
  bn="- **ডানতমের জন্য:** যখন আমরা টার্গেট খুঁজে পাই, আমরা ডানে সার্চ চালিয়ে যাই শেষ ঘটনা খুঁজে পেতে"
/>
