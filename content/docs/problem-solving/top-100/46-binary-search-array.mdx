...
<TranslatedText
  en="- **O(log n) Time**: Binary search is very efficient for large sorted arrays"
  bn="- **O(log n) সময়**: বাইনারি সার্চ বড় সর্ট করা অ্যারের জন্য খুবই কার্যকর"
/>

<TranslatedText
  en="- **Sorted Requirement**: Only works on sorted data - crucial constraint"
  bn="- **সর্ট করা প্রয়োজনীয়তা**: শুধুমাত্র সর্ট করা ডেটাতে কাজ করে - গুরুত্বপূর্ণ সীমাবদ্ধতা"
/>

<TranslatedText
  en="- **Divide and Conquer**: Repeatedly halves search space until target found or space empty"
  bn="- **ভাগ করো এবং জয় করো**: টার্গেট পাওয়া বা স্পেস খালি না হওয়া পর্যন্ত বারবার সার্চ স্পেস অর্ধেক করে"
/>

<TranslatedText
  en="- **Iterative Preferred**: Iterative approach is better than recursive (no stack overhead)"
  bn="- **ইটারেটিভ পছন্দসই**: ইটারেটিভ পদ্ধতি রিকার্সিভের চেয়ে ভালো (কোনো স্ট্যাক ওভারহেড নেই)"
/>

<TranslatedText
  en="- **Many Variants**: First/last occurrence, insertion position, closest element, etc."
  bn="- **অনেক বৈচিত্র্য**: প্রথম/শেষ ঘটনা, সন্নিবেশ অবস্থান, নিকটতম এলিমেন্ট, ইত্যাদি"
/>
