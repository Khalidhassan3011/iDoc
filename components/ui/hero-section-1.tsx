...
import { ArrowRight, ChevronRight, Menu, X, Search, Moon, Sun } from "lucide-react";
              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                    Comprehensive interview preparation resources for Flutter,
                    Laravel, and more. Practice with AI-powered mock tests and
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Link href="/docs">
                        <span className="text-nowrap">Browse Documentation</span>
                      </Link>
                    </Button>
                  </div>
                  <Button
                  ...
                  >
                    <Link href="/test-your-skill">
                      <span className="text-nowrap">Test Your Skills</span>
                    </Link>
                  </Button>
                </AnimatedGroup>
              </div>
...
const menuItems = [
  ...
  { name: "Practice", href: "/test-your-skill" },
  { name: "Flutter", href: "/docs/flutter" },
  { name: "Problem Solving", href: "/docs/problem-solving" },
];
          ...
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            ...
            <div className="hidden lg:flex items-center gap-3 ml-auto">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-full border bg-background/50 hover:bg-background transition-colors min-w-[240px]"
                aria-label="Search"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-full border bg-background/50 hover:bg-background transition-colors h-10 w-10"
            ...
            {/* Mobile Menu & Get Started Button - Commented Out */}
